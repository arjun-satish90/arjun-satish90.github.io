...
![](https://cdn-images-1.medium.com/max/2000/1*VprmT6-BTfzuuW23QNXfag.jpeg)([Source](https://www.pexels.com/photo/light-nature-sky-water-133682/))
...
<iframe width="700" height="250" src="/media/cd29fbc0f13c8d59901db71bafc4a558?postId=5d6830408467" data-media-id="cd29fbc0f13c8d59901db71bafc4a558" allowfullscreen="" frameborder="0"></iframe>Medium to Markdown JS script
...
<iframe width="700" height="250" src="/media/9fa7158625aba04ecb82e251279f889a?postId=5d6830408467" data-media-id="9fa7158625aba04ecb82e251279f889a" allowfullscreen="" frameborder="0"></iframe>Command line usage of Python script for converting medium to Markdown.
...
![](https://cdn-images-1.medium.com/max/1600/1*LWlPcjW-SLHUZt6PiEDbbw.png)Website after pushing changes to GitHub.
...
<pre name="e877" id="e877" class="graf graf--pre graf-after--p">// Captions for images
img + em {
    font-style: italic;
    font-weight: 600;
    margin-bottom: 20px;
...
![](https://cdn-images-1.medium.com/max/1600/1*11NN5Fv_WwaAH0-Te62aVA.png)![](https://cdn-images-1.medium.com/max/1600/1*biazqiCBQ75FzIhwJUjLFQ.png)

The caption will now be centered below the image.

![](https://cdn-images-1.medium.com/max/1600/1*L3mWU911AGzYNLZmhHDvTA.png)Caption centered below image.
...
![](https://cdn-images-1.medium.com/max/1600/1*rvgO-ghHjwaRV4ITr9J9Rg.png)Side by Side Images using a table

Here’s the blank code for a table so just replace the `image_link` and `header`:

<pre name="69ae" id="69ae" class="graf graf--pre graf-after--p graf--trailing">Header Left |  Header Right
:--------:|:-------:
![](image_link)  |  ![](image_link)</pre>
...
<pre name="cc17" id="cc17" class="graf graf--pre graf-after--p">```python
...
![](https://cdn-images-1.medium.com/max/1600/1*OqiP9dlVHfIi6rVH0O6J0w.png)Default Python syntax highlighting with Rouge

Using a custom defined theme, the highlighting comes out like so:

![](https://cdn-images-1.medium.com/max/1600/1*E_SnqNetmD4-AUll1ozXvQ.png)Custom Python syntax highlighting
...
![](https://cdn-images-1.medium.com/max/1600/1*zVdpXVfSBVDn45Zl2W1LkA.png)GitHub Gist in Markdown
...
![](https://cdn-images-1.medium.com/max/1600/1*VZlj8trqLdQsrJpPSlMN2A.png)Default excerpt shown on blog home page

To extend the excerpt, add the following line to `_config.yaml`:

<pre name="6823" id="6823" class="graf graf--pre graf-after--p"># Specifies end of excerpt
excerpt_separator: <!--more--></pre>

Then put the `<!--more-->` tag in the post markdown wherever you want the excerpt to end.

![](https://cdn-images-1.medium.com/max/1200/1*nEdFaOBe95GqIJx-j0YNkA.png)![](https://cdn-images-1.medium.com/max/1200/1*cHG1Csan0gpffqk3pnButQ.png)Specifying extent of post excerpt in Markdown (left) and how it looks on my website (right).
